...
vim.keymap.set("n", "<leader>nf", "<cmd>Neotree reveal<CR>", { desc = "Toggle [N]vim [R]eveal" })
vim.keymap.set("n", "<leader>nb", "<cmd>Neotree buffer<CR>", { desc = "Toggle [N]vim [T]ree buffer" })
...
-- For to open scrips from Godot Engine
